...
if ($object->id > 0) {
    ...
    print '        </div>';
    print '        <div class="digiai-summary-grid">';
    print '          <section class="digiai-summary-card">';
    print '            <h4><i class="fas fa-lightbulb"></i> ' . $langs->trans('DigiAiSummaryRecommendations') . '</h4>';
    print '            <div data-digiai-recommendations data-empty="' . dol_escape_htmltag($langs->trans('DigiAiSummaryNoRecommendations')) . '"></div>';
    print '          </section>';
    print '          <section class="digiai-summary-card">';
    print '            <h4><i class="fas fa-stream"></i> ' . $langs->trans('DigiAiSummarySummaries') . '</h4>';
    print '            <p data-digiai-summaries data-empty="' . dol_escape_htmltag($langs->trans('DigiAiSummaryNoSummaries')) . '"></p>';
    print '          </section>';
    print '          <section class="digiai-summary-card">';
    print '            <h4><i class="fas fa-tachometer-alt"></i> ' . $langs->trans('DigiAiSummaryConfidence') . '</h4>';
    print '            <span class="digiai-badge" data-digiai-confidence data-empty="' . dol_escape_htmltag($langs->trans('DigiAiSummaryNoConfidence')) . '"></span>';
    print '          </section>';
    print '          <section class="digiai-summary-card">';
    print '            <h4><i class="fas fa-tasks"></i> ' . $langs->trans('DigiAiSummaryWorkflow') . '</h4>';
    print '            <dl class="digiai-summary-details">';
    print '              <div><dt>' . $langs->trans('DigiAiSummaryLabel') . '</dt><dd data-digiai-label data-empty="' . dol_escape_htmltag($langs->trans('DigiAiSummaryNoLabel')) . '"></dd></div>';
    print '              <div><dt>' . $langs->trans('DigiAiSummaryStatus') . '</dt><dd class="digiai-badge" data-digiai-status data-empty="' . dol_escape_htmltag($langs->trans('DigiAiSummaryNoStatus')) . '"></dd></div>';
    print '              <div><dt>' . $langs->trans('DigiAiSummaryReviewer') . '</dt><dd data-digiai-reviewer data-empty="' . dol_escape_htmltag($langs->trans('DigiAiSummaryNoReviewer')) . '"></dd></div>';
    print '              <div><dt>' . $langs->trans('DigiAiSummaryComment') . '</dt><dd data-digiai-comment data-empty="' . dol_escape_htmltag($langs->trans('DigiAiSummaryNoComment')) . '"></dd></div>';
    print '            </dl>';
    print '          </section>';
    print '        </div>';
    print '        <div class="digiai-summary-grid">';
    print '          <section class="digiai-summary-card digiai-summary-card--full">';
    print '            <h4><i class="fas fa-leaf"></i> ' . $langs->trans('DigiAiSummaryEvaluations') . '</h4>';
    print '            <div data-digiai-evaluations data-empty="' . dol_escape_htmltag($langs->trans('DigiAiSummaryNoEvaluations')) . '" data-label-environmental="' . dol_escape_htmltag($langs->trans('DigiAiEvaluationEnvironmental')) . '" data-label-psychosocial="' . dol_escape_htmltag($langs->trans('DigiAiEvaluationPsychosocial')) . '" data-label-ergonomic="' . dol_escape_htmltag($langs->trans('DigiAiEvaluationErgonomic')) . '" data-label-action="' . dol_escape_htmltag($langs->trans('DigiAiEvaluationActionPlan')) . '"></div>';
    print '          </section>';
    print '          <section class="digiai-summary-card digiai-summary-card--full">';
    print '            <h4><i class="fas fa-file-alt"></i> ' . $langs->trans('DigiAiSummaryDocuments') . '</h4>';
    print '            <div data-digiai-documents data-empty="' . dol_escape_htmltag($langs->trans('DigiAiSummaryNoDocuments')) . '" data-link-label="' . dol_escape_htmltag($langs->trans('DigiAiSummaryOpenDocument')) . '"></div>';
    print '          </section>';
    print '        </div>';
    print '      </div>';
