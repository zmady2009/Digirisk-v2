...
class modDigiriskdolibarr extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->const = [
            ...
            $i++ => ['DIGIRISKDOLIBARR_TICKET_WEBHOOK_ENABLED', 'integer', 0, '', 0, 'current'],
            $i++ => ['DIGIRISKDOLIBARR_TICKET_WEBHOOK_ENDPOINT', 'chaine', '', '', 0, 'current'],
            $i++ => ['DIGIRISKDOLIBARR_TICKET_WEBHOOK_SECRET', 'chaine', '', '', 0, 'current'],
            $i++ => ['DIGIRISKDOLIBARR_TICKET_WEBHOOK_TIMEOUT', 'integer', 5, '', 0, 'current'],
            $i++ => ['DIGIRISKDOLIBARR_TICKET_WEBHOOK_RETRY', 'integer', 0, '', 0, 'current'],
